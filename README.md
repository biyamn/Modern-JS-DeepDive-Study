...
- 매주 질문자를 한명 정하고, 질문자는 전날(월요일 23:59)까지 디스코드 '매주-질문-공유' 방에 질문을 5개 올립니다.
- 질문자를 제외한 스터디원은 당일에 사다리타기로 배정된 1개의 질문에 답합니다.
- 공부한 정해진 챕터는 정리하여 깃허브의 주차 폴더 안에 .md파일로 공유합니다.

## 📚 Github 저장소

- 업로드할 폴더명과 폴더에 담을 파일명은 아래와 같이 작성해주세요.
- 예시: https://github.com/namu56/modern-javascript-study
...
|  02  | 04월 02일 14:00 |  8, 9, 10, 11  | 문소영 |      |
